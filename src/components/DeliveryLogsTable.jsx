...
// Table component that renders delivery log entries.
// Props:
//   logs     – array of delivery log objects
//   onRetry  – callback fired when the "Retry Now" button is clicked
  ...
  return (
    <div className="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
      <table className="min-w-full divide-y divide-gray-200 text-sm">
        ...
        {/* Table body – one row per delivery log entry */}
        <tbody className="divide-y divide-gray-100 bg-white">
          {logs.map((log) => (
            <tr key={log.id} className="hover:bg-gray-50 transition-colors">
              ...
              {/* Retry button (only for failed rows) */}
