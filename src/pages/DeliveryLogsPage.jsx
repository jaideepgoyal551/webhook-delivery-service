...
// Page that displays delivery logs for all webhook endpoints.
// Props:
//   logs    – array of delivery log objects (lifted state from App)
//   onRetry – callback to retry a failed delivery
export default function DeliveryLogsPage({ logs, onRetry }) {
  // Compute summary counts for the header stats
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Recent delivery attempts for all webhook endpoints.
          </p>
        </div>
      </div>
